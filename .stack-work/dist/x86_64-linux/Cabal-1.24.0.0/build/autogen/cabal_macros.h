...
/* package free-game-1.1.90 */
#define VERSION_free_game "1.1.90"
#define MIN_VERSION_free_game(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  1 || \
  (major1) == 1 && (major2) == 1 && (minor) <= 90)
...
#define CURRENT_COMPONENT_ID "connect-four-0.1.0.0-7cGRyIthS8B8ymeMztx9c8"

#define CURRENT_PACKAGE_KEY "connect-four-0.1.0.0-7cGRyIthS8B8ymeMztx9c8"
